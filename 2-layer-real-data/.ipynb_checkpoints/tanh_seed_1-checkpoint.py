...
Xtrain = Xtrain[np.random.RandomState(1).permutation(len(Xtrain))].T
...
alphas = [0.04, 0.125, 0.25, 0.375, 0.5, 2/3, 5/6, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75] 
...
with open(f'tanh_seed_1.csv', 'w', newline='') as file:

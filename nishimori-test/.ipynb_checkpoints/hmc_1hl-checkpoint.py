...
def data_generate(d, alpha, gamma, sig, Delta, vlaw):
...
def test_error(W1, W2, v, sig, Xtest):
    l1 = pre_activation(v, sig, W1, Xtest)
    l2 = pre_activation(v, sig, W2, Xtest)
    return tf.reduce_mean((l1-l2)**2)/2
